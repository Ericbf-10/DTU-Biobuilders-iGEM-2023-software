...
#BSUB -o maws_try_cores_%J.out 
#BSUB -e maws_try_cores_%J.err 
...
# Run MAWS
python MAWS2023.py -p pfoa.pdb -n maws_try_cores -nt 3 -ta DNA -tm organic -cenv maws_p3 -c1 10 -c2 10
